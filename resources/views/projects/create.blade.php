			...
			<div class="row ">
				<div class="portlet box blue">
                									<div class="portlet-title">
                										<div class="caption">
                											<i class="fa fa-gift"></i>Create Project
                										</div>
                									...
                									<div class="portlet-body form">
                										<!-- BEGIN FORM-->
                										<form method="POST" action="/projects/store" class="horizontal-form">
                												...
                												<div class="row">
                													<div class="col-md-6">
                														<div class="form-group">
                															...
                															<input type="text" id="project_name" name="project_name" class="form-control" placeholder="My project" value="{{ old('project_name') }}">
                															<span class="help-block">
                															Type your's project name </span>
                														</div>
                													</div>
                													<!--/span-->
                													<div class="col-md-6">
                														<div class="form-group has-error">
                															<label class="control-label">Short Key</label>
                															<input type="text" id="short_key" name="short_key" class="form-control" placeholder="Key" value="{{ old('short_key') }}">
                															<span class="help-block">
                															It prefixes each issue in the project ex.(EXT) Max. 10 characters.</span>
                														</div>
                													</div>
                													<!--/span-->
                												</div>
                												...
                												<div class="row">
                													...
                													<div class="col-md-6">
                														<div class="form-group">
                															...
                															<input type="text" name="url" class="form-control" placeholder="http://example.com" value="{{ old('url') }}">
                														</div>
                													</div>
                													<!--/span-->
                												</div>

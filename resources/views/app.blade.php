...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="/">
			<img src="/layout/img/logo.png" alt="logo" class="logo" style="width: 150px;"/>
			</a>
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<img src="/layout3/img/avatar2.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
...
<div class="page-footer">
	<div class="page-footer-inner">
		 2015 &copy; Incvisio - Issue & Project Tracking Software.
	</div>

...
<link href="/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input type="email" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" value="{{ old('email') }}"/>
			</div>
		</div>
		<div class="form-group">
...
<script src="/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
jQuery(document).ready(function() {
  ...
  Demo.init();
       ...
       $.backstretch([
        "/pages/media/bg/1.jpg",
        "/pages/media/bg/2.jpg",
        "/pages/media/bg/3.jpg",
        "/pages/media/bg/4.jpg"
        ], {
          fade: 1000,
          duration: 8000
    }
